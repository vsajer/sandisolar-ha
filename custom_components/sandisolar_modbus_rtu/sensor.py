...
class BatteryPowerSensor(BaseSandiSensor):
    ...
    async def async_update(self):
        ...
        # + = vybíjení baterie, - = nabíjení baterie
...
class WorkTimeSensor(BaseSandiSensor):
    ...
    async def async_update(self):
        ...
        # Registr 107-108 je v jednotkách 0.5 min
        hours = (val * 0.5) / 60
...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    entities = [
        ...
        SimpleSensor(
            hub,
            "eps_local_load_power",
            "EPS Local Load Power",
            UnitOfPower.WATT,
            SensorDeviceClass.POWER,
        ...
        # STATUS / WARNINGS
        # ==============================================================
        GridStatusTextSensor(
            hub,
            "inverter_status",
            "Inverter Status",
        ),
        BatteryStatusTextSensor(
            hub,
            "battery_status",
            "Battery Status",
        ),
        FaultWord0TextSensor(
            hub,
            "fault_word0",
            "Fault Word0 Text",
        ),
        WarningMainTextSensor(
            hub,
            "warning_main",
            "Warning Main Text",
        ),
        WarningSubTextSensor(
            hub,
            "warning_sub",
            "Warning Sub Text",
        ),
